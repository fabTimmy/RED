    ...
    <div class="d-flex align-items-stretch">
        <div id="sidebar" class="sidebar py-3">
            ...
            <ul class="sidebar-menu list-unstyled">
                ...
                <li class="sidebar-list-item"><a href="contacts.php" class="sidebar-link text-muted active"><i class="o-user-1 mr-3 text-gray"></i><span>Contacts</span></a></li>
            ...
            <div class="container-fluid px-xl-5">
                ...
                <table class="table table-striped table-hover">
                                            <thead>
                                                ...
                                                <tr>
                                                    <th class="bb-2">S/N</th>
                                                    <th class="bb-2">Number</th>
                                                    <th class="bb-2">Name</th>
                                                    <th class="bb-2">Designation</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                            <tr>
                                                ...
                                                <tr style="background:rgba(0,0,30,0.4);color:#fff;">
                                                    <td colspan="4"><i>Important Contacts</i></td>
                                                </tr>
                                              </tbody>
                                    </table>                  
                </div>
